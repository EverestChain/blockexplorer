...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(51535);
...
const Desktop = ({
  ...
  const formattedItems = items.map(x => {
    const amount = (0,_utils_format_token__WEBPACK_IMPORTED_MODULE_5__/* .formatNumber */ .uf)(x.amount.value, x.amount.exponent);
    const reward = (0,_utils_format_token__WEBPACK_IMPORTED_MODULE_5__/* .formatNumber */ .uf)(x.reward.value, x.reward.exponent);
    return {
      validator: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx(_components__WEBPACK_IMPORTED_MODULE_4__/* .AvatarName */ .gj, {
