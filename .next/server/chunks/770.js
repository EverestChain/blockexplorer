...
/* harmony import */ var _src_utils_format_token__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(42570);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(29081);
...
const Desktop = ({
  ...
  const formattedItems = items.map(x => {
    return {
      validator: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx(_components__WEBPACK_IMPORTED_MODULE_5__/* .AvatarName */ .gj, {
        address: x.validator.address,
        imageUrl: x.validator.imageUrl,
        name: x.validator.name
      }),
      amount: `${(0,_src_utils_format_token__WEBPACK_IMPORTED_MODULE_8__/* .formatNumber */ .uf)(x.amount.value, x.amount.exponent)} ${x.amount.displayDenom.toUpperCase()}`,
